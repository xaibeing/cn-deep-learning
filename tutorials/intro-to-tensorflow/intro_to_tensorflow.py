...
#    print('min(image_data)',min(image_data))
#    print('max(image_data)',max(image_data))
#    print('(image_data - min(image_data))',(image_data - min(image_data)))
#    print('(image_data - min(image_data)) * (0.9-0.1)',(image_data - min(image_data)) * (0.9-0.1))
    return 0.1 + (image_data - np.min(image_data,0)) * (0.9-0.1) / (np.max(image_data,0) - np.min(image_data,0))
...
weights = tf.Variable(tf.truncated_normal(shape=[features_count,labels_count], mean=0, stddev=1))
